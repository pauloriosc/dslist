Este projeto é uma aplicação Java Spring desenvolvida como parte do curso Java Spring da DevSuperior. O objetivo é criar uma API para gerenciar um banco de dados de jogos, organizados em categorias.
